...
//echo $convidante;
echo "codigo=".$codigo." - ".$nome." - ".$nota." - ".$tipo." - ".$convidante;
 ...
 if($codigo and $nome and $nota and $tipo){
  if($codigo == "novo"){
   ...
   if($convidante>0){
    ...
    $params = array($nome, $abreviatura, $nota, $tipo, $codigo, null);
    echo "2";
    $result = pg_query_params( $conn, 'UPDATE JOGADOR SET nome=$1, abreviatura=$2, nota=$3, tipo=$4, convidante=$6 where id_jogador=$5', $params);
   }
